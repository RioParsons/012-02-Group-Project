...
function initializeContent() {
    EVENT_MODAL = new bootstrap.Modal(document.getElementById('event-modal', true, true, true));
...
const CALENDAR_EVENTS = [
    {
      name: 'CSCI3308 Office Hours',
      day: 'tuesday',
      time: '12:30',
      modality: 'in-person',
      location: 'CSEL',
      url: '',
      attendees: 'Every Single Person',
    },
    {
      name: 'Interview',
      day: 'tuesday',
      ...
      location: '',
      url: 'www.meeting.com',
      attendees: 'Me, Bob Recuiter, Jason Engineering Manager',
    },
];
